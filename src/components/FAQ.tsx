...
export default function FAQ() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: (<>Boxing classes usually start with multiple rounds of jump rope, followed by technique drills and heavy bag work. For competitive boxers, some classes also involve sparring sessions. Feel free to visit us during a class to see what training is like. <a href="/pricingschedule" class="link">See our schedule.</a></>),
    },
    {
    ...
    },
    {
      ...
      answer: "Of course! Visit us for one free class to see what it's like."
    }
  ];
