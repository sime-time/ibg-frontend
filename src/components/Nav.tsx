...
export function NavMenu(props: { onNavClick?: () => void }) {
  return (
    <>
      <li><a href="/" onClick={props.onNavClick}>Home</a></li>
      <li><a href="/our-team" onClick={props.onNavClick}>Our Team</a></li>
      <li><a href="/pricingschedule" onClick={props.onNavClick}>Schedule</a></li>
      <li><a href="/contact-us" onClick={props.onNavClick}>Contact Us</a></li>
    </>
  );
}
