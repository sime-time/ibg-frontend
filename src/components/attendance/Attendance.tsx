  ...
  return (
              ...
              <div class="flex flex-col gap-4 w-full">
                <div>
                  ...
                  <p class="py-2 text-wrap">
                    Track gym attendance for a specific day.
                  </p>
                </div>
                ...
                <div class="flex">
                  <button
                    onClick={() => setAttendListIsOpen(true)}
    ...
    >
      ...
      <div class="w-11/12 md:w-5/6 lg:w-2/3 card bg-base-100 shadow-xl px-6 pt-8">
        <button
          onClick={() => setAttendListIsOpen(false)}
          class="btn btn-sm btn-circle btn-ghost absolute left-3 md:left-6 top-8"
        >
          <FaSolidArrowLeft class="size-4" />
        </button>
        <div class="flex flex-col gap-4 justify-center">
          <h2 class="text-2xl font-semibold text-center">
            {formatDate(attendDate())}
          </h2>
                      ...
                      <td>
                        <label class="w-full flex justify-end">
                          <input
                            ...
                            checked={
                              member.checkedIn /*ignore red underline this is valid*/
                            }
                          />
                        </label>
                      </td>
