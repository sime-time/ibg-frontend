...
export function MemberTable() {
  ...
  const openEditDialog = async (memberId: string) => {
    ...
    getMemberEmergencyContact(memberId)
      .then((contact) => {
  ...
  const confirmEdit = async (e: Event, memberId: string) => {
    ...
    try {
      ...
      updateMember(memberId, validValues)
        .then(() => {
          // clean up
                            ...
                            fallback={
                              <div class="flex flex-col gap-4">
                                ...
                                <button
                                  onClick={() =>
                                    openDeleteModal(
                                      memberToEdit.id.value,
                                      memberToEdit.name.value
                                    )
                                  }
                          ...
                          >
                                ...
                                <button
                                  onClick={() => {
                                    setMemberToEdit(
                                      "phone",
                                      "readyToEdit",
                                      !memberToEdit.phone.readyToEdit
                                    );
                              ...
                              <div class="flex gap-3 w-full">
                                <label class="input input-bordered flex items-center gap-2 grow border-secondary">
                                  ...
                                  <input
                                    ...
                                    class="grow"
                                    placeholder={
                                      memberToEdit.emergencyName.value
                                    }
                                    value={memberToEdit.emergencyName.value}
                                    disabled={
                                      !memberToEdit.emergencyName.readyToEdit
                                    }
                              ...
                              <div class="flex gap-3 w-full">
                                <label class="input input-bordered flex items-center gap-2 grow border-secondary">
                                  ...
                                  <input
                                    ...
                                    class="grow"
                                    placeholder={
                                      memberToEdit.emergencyPhone.value
                                    }
                                    value={memberToEdit.emergencyPhone.value}
                                    disabled={
                                      !memberToEdit.emergencyPhone.readyToEdit
                                    }
                            ...
                            <div class="modal-action">
                              <form method="dialog" class="flex gap-4 w-full">
                                <button
                                  onClick={(event) =>
                                    confirmEdit(event, memberToEdit.id.value)
                                  }
